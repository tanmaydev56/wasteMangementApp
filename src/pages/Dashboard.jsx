            ...
            {isOpen && (
              <div className="absolute right-0 mt-2 w-40 bg-white border border-gray-200 rounded shadow-lg z-10">
                <ul>
                  ...
                  <NavLink to={"/settings"} className="px-4 py-2 hover:bg-gray-100 cursor-pointer">Settings</NavLink>
                  <NavLink to={"/login"} onClick={handleLogout} className="px-4 py-2 hover:bg-gray-100 cursor-pointer">Logout</NavLink>
                </ul>
              </div>
            )}
          </div>
