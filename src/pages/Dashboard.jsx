            ...
            {isOpen && (
              <div className="absolute right-0 mt-2 w-40 bg-white border border-gray-200 rounded shadow-lg z-10">
                <ul>
                  ...
                  <NavLink to={"/settings"} ><li className='px-4 py-2 hover:bg-gray-100 cursor-pointer'>Settings</li></NavLink>
                  <NavLink to={"/login"} onClick={handleLogout} ><li className="px-4 py-2 hover:bg-gray-100 cursor-pointer">Logout</li></NavLink>
                </ul>
              </div>
            )}
          </div>
